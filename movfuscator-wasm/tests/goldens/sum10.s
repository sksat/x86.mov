...
# emit/mov>cnsti4(0)
movl $0, (R3)
# emit/mov>asgni4(addrlp4(sum),cnsti4(0))
...
# emit/mov>addi4(indiri4(addrlp4(sum)),indiri4(addrlp4(i)))
...
# emit/mov>asgni4(addrlp4(sum),addi4(indiri4(addrlp4(sum)),indiri4(addrlp4(i))))
...
# emit/mov>cnsti4(10)
movl $10, (R2)
# emit/mov>lei4(indiri4(addrlp4(i)),cnsti4(10))
...
# emit/mov>reti4(indiri4(addrlp4(sum)))
