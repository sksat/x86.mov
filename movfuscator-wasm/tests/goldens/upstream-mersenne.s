...
# emit/mov>cnsti4(5)
movl $5, (R3)
# emit/mov>asgni4(addrlp4(d),cnsti4(5))
...
# emit/mov>cnsti4(2)
movl $2, (R2)
# emit/mov>modi4(indiri4(addrfp4(n)),cnsti4(2))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>nei4(modi4(indiri4(addrfp4(n)),cnsti4(2)),cnsti4(0))
...
# emit/mov>cnsti4(0)
movl $0, (R3)
# emit/mov>asgni4(addrlp4(4),cnsti4(0))
...
# emit/mov>cnsti4(3)
movl $3, (R2)
# emit/mov>modi4(indiri4(addrfp4(n)),cnsti4(3))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>nei4(modi4(indiri4(addrfp4(n)),cnsti4(3)),cnsti4(0))
...
# emit/mov>cnsti4(3)
movl $3, (R2)
# emit/mov>nei4(indiri4(addrfp4(n)),cnsti4(3))
...
# emit/mov>cnsti4(1)
movl $1, (R3)
# emit/mov>asgni4(addrlp4(9),cnsti4(1))
...
# emit/mov>cnsti4(0)
movl $0, (R3)
# emit/mov>asgni4(addrlp4(9),cnsti4(0))
...
# emit/mov>reti4(indiri4(addrlp4(9)))
...
# emit/mov>modi4(indiri4(addrfp4(n)),indiri4(addrlp4(d)))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>nei4(modi4(indiri4(addrfp4(n)),indiri4(addrlp4(d))),cnsti4(0))
...
# emit/mov>cnsti4(2)
movl $2, (R2)
# emit/mov>addi4(indiri4(addrlp4(d)),cnsti4(2))
...
# emit/mov>asgni4(addrlp4(d),addi4(indiri4(addrlp4(d)),cnsti4(2)))
...
# emit/mov>cnsti4(4)
movl $4, (R2)
# emit/mov>addi4(indiri4(addrlp4(d)),cnsti4(4))
...
# emit/mov>asgni4(addrlp4(d),addi4(indiri4(addrlp4(d)),cnsti4(4)))
...
# emit/mov>asgni4(vregp(1),indiri4(addrlp4(d)))
...
# emit/mov>cnsti4(929)
movl $929, (R3)
# emit/mov>asgni4(addrlp4(q),cnsti4(929))
...
# emit/mov>argi4(indiri4(addrlp4(q)))
...
# emit/mov>calli4(addrgp4(isPrime))
...
# emit/mov>load(calli4(addrgp4(isPrime)))
...
# emit/mov>asgni4(vregp(1),load(calli4(addrgp4(isPrime))))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>nei4(indiri4(vregp(1)),cnsti4(0))

# emit nei

movl (R3), %eax
movl (R2), %edx
movl $.LCI21-0x80000000, %ecx
# jmp_nei
movl %ecx, (branch_temp)
# alu_cmp
movl %eax, (alu_x)
...
# emit/mov>jumpv(addrgp4(20))

# emit jumpv

# (direct jump)
movl $.LCI20-0x80000000, %eax
# jmp_jumpv
movl %eax, (branch_temp)
# store target (branch_temp) (on)
movl (on), %eax
...
# emit/mov>asgni4(addrlp4(r),indiri4(addrlp4(q)))
...
# emit/mov>cnsti4(1)
movl $1, (R2)
# emit/mov>lshi4(indiri4(addrlp4(r)),cnsti4(1))
...
# emit/mov>asgni4(addrlp4(r),lshi4(indiri4(addrlp4(r)),cnsti4(1)))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>gti4(indiri4(addrlp4(r)),cnsti4(0))
...
# emit/mov>lshi4(indiri4(addrlp4(q)),indiri4(vregp(2)))
...
# emit/mov>addi4(lshi4(indiri4(addrlp4(q)),indiri4(vregp(2))),indiri4(vregp(2)))
...
# emit/mov>asgni4(addrlp4(d),addi4(lshi4(indiri4(addrlp4(q)),indiri4(vregp(2))),indiri4(vregp(2))))
...
# emit/mov>asgni4(addrlp4(p),indiri4(addrlp4(r)))
...
# emit/mov>asgni4(vregp(3),indiri4(addrlp4(i)))
...
# emit/mov>muli4(indiri4(vregp(3)),indiri4(vregp(3)))
...
# emit/mov>modi4(muli4(indiri4(vregp(3)),indiri4(vregp(3))),indiri4(addrlp4(d)))
...
# emit/mov>asgni4(addrlp4(i),modi4(muli4(indiri4(vregp(3)),indiri4(vregp(3))),indiri4(addrlp4(d))))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>gei4(indiri4(addrlp4(p)),cnsti4(0))
...
# emit/mov>cnsti4(1)
movl $1, (R2)
# emit/mov>lshi4(indiri4(addrlp4(i)),cnsti4(1))
...
# emit/mov>asgni4(addrlp4(i),lshi4(indiri4(addrlp4(i)),cnsti4(1)))
...
# emit/mov>lei4(indiri4(addrlp4(i)),indiri4(addrlp4(d)))

# emit lei

movl (R3), %eax
movl (R2), %edx
movl $.LCI35-0x80000000, %ecx
# jmp_lei
movl %ecx, (branch_temp)
# alu_cmp
movl %eax, (alu_x)
...
# emit/mov>subi4(indiri4(addrlp4(i)),indiri4(addrlp4(d)))
...
# emit/mov>asgni4(addrlp4(i),subi4(indiri4(addrlp4(i)),indiri4(addrlp4(d))))
...
# emit/mov>cnsti4(1)
movl $1, (R2)
# emit/mov>lshi4(indiri4(addrlp4(p)),cnsti4(1))
...
# emit/mov>asgni4(addrlp4(p),lshi4(indiri4(addrlp4(p)),cnsti4(1)))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>nei4(indiri4(addrlp4(p)),cnsti4(0))
...
# emit/mov>cnsti4(1)
movl $1, (R2)
# emit/mov>eqi4(indiri4(addrlp4(i)),cnsti4(1))
...
# emit/mov>cnsti4(1)
movl $1, (R1)
# emit/mov>lshi4(indiri4(addrlp4(q)),cnsti4(1))
...
# emit/mov>addi4(indiri4(addrlp4(d)),lshi4(indiri4(addrlp4(q)),cnsti4(1)))
...
# emit/mov>asgni4(addrlp4(d),addi4(indiri4(addrlp4(d)),lshi4(indiri4(addrlp4(q)),cnsti4(1))))
...
# emit/mov>jumpv(addrgp4(26))

# emit jumpv

# (direct jump)
movl $.LCI26-0x80000000, %eax
# jmp_jumpv
movl %eax, (branch_temp)
# store target (branch_temp) (on)
movl (on), %eax
