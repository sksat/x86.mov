...
# emit/mov>cnsti4(1)
movl $1, (R2)
# emit/mov>nei4(indiri4(addrfp4(x)),cnsti4(1))
...
# emit/mov>cnsti4(2)
movl $2, (R2)
# emit/mov>nei4(indiri4(addrfp4(x)),cnsti4(2))
...
# emit/mov>modi4(indiri4(addrfp4(x)),indiri4(addrlp4(i)))
...
# emit/mov>cnsti4(0)
movl $0, (R2)
# emit/mov>nei4(modi4(indiri4(addrfp4(x)),indiri4(addrlp4(i))),cnsti4(0))
...
# emit/mov>lei4(muli4(indiri4(vregp(1)),indiri4(vregp(1))),indiri4(addrfp4(x)))
...
# emit/mov>cnsti4(10000)
movl $10000, (R2)
# emit/mov>lti4(indiri4(addrlp4(i)),cnsti4(10000))
