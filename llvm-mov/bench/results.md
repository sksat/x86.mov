...
Generated 2026-08-19T11:20:05Z on x86_64 (Linux).
...
| wall-clock runtime (hyperfine mean) | 0.212 ms | 0.611 ms | 0.140 ms | 0.151 ms | 0.152 ms | 0.117 ms |
...
| wall-clock runtime (hyperfine mean) | 0.192 ms | 0.572 ms | 0.144 ms | 0.147 ms | 0.147 ms | 0.162 ms |
...
| wall-clock runtime (hyperfine mean) | 0.206 ms | 0.616 ms | 0.135 ms | 0.160 ms | 0.159 ms | 0.140 ms |
...
| wall-clock runtime (hyperfine mean) | 0.184 ms | 0.672 ms | 0.148 ms | 0.141 ms | 0.162 ms | 0.153 ms |
...
| wall-clock runtime (hyperfine mean) | 0.198 ms | 0.725 ms | 0.132 ms | 0.136 ms | 0.152 ms | 0.119 ms |
...
| wall-clock runtime (hyperfine mean) | 0.202 ms | 0.681 ms | 0.140 ms | 0.150 ms | 0.133 ms | 0.138 ms |
...
| wall-clock runtime (hyperfine mean) | 0.209 ms | 0.661 ms | 0.157 ms | 0.149 ms | 0.130 ms | 0.127 ms |
...
| wall-clock runtime (hyperfine mean) | 0.171 ms | 0.707 ms | 0.131 ms | 0.177 ms | 0.128 ms | 0.126 ms |
...
| wall-clock runtime (hyperfine mean) | 0.201 ms | 0.643 ms | 0.127 ms | 0.143 ms | 0.130 ms | 0.142 ms |
...
| wall-clock runtime (hyperfine mean) | 74.447 ms | 559.909 ms | 0.793 ms | 0.335 ms | 0.358 ms | 0.265 ms |
...
| wall-clock runtime (hyperfine mean) | 0.186 ms | 0.665 ms | 0.173 ms | 0.140 ms | 0.126 ms | 0.135 ms |
...
| wall-clock runtime (hyperfine mean) | 0.186 ms | — | 0.143 ms | 0.143 ms | 0.123 ms | 0.134 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 71.618 ms | — | 0.765 ms | 0.362 ms | 0.316 ms | 0.323 ms |
...
| wall-clock runtime (hyperfine mean) | 0.212 ms | — | — | — | — | — |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.194 ms | — | 0.147 ms | 0.126 ms | 0.131 ms | 0.151 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.214 ms | — | 0.129 ms | 0.129 ms | 0.138 ms | 0.142 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.205 ms | — | 0.136 ms | 0.134 ms | 0.151 ms | 0.132 ms |
...
| .text size | 22879 | — | — | 6219 | 6347 | 6347 |
| .rodata size | 728312 | — | — | 5016 | 5016 | 5016 |
| mov count / total | 5006 / 6226 (80.4%) | — | — | 669 / 1862 (35.9%) | 671 / 1893 (35.4%) | 671 / 1893 (35.4%) |
...
| wall-clock runtime (hyperfine mean) | 0.228 ms | — | — | 0.140 ms | 0.139 ms | 0.142 ms |
...
| metric | llvm-mov (Rust) | movfuscator | rustc -O0 | rustc -O1 | rustc -O2 | rustc -O3 |
|---|---:|---:|---:|---:|---:|---:|
| total ELF (bytes) | 2214132 | — | — | 1242212 | 1242212 | 1242212 |
| .text size | 115052 | — | — | 821 | 1126 | 1088 |
| .rodata size | 855594 | — | — | 42 | 42 | 42 |
| mov count / total | 19129 / 19176 (99.8%) | — | — | 78 / 246 (31.7%) | 111 / 342 (32.5%) | 111 / 334 (33.2%) |
...
| wall-clock runtime (hyperfine mean) | 0.784 ms | — | — | 0.129 ms | 0.141 ms | 0.132 ms |
