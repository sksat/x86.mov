...
Generated 2026-05-28T01:16:07Z on x86_64 (Linux).
...
| wall-clock runtime (hyperfine mean) | 0.180 ms | 0.534 ms |
...
| mov count / total | 129 / 132 (97.7%) | 775 / 777 (99.7%) |
| non-mov mnemonics | `call int jmp` | `call` |
| wall-clock runtime (hyperfine mean) | 0.157 ms | 0.549 ms |
...
| non-mov mnemonics | `call int jmp` | `call` |
| wall-clock runtime (hyperfine mean) | 0.175 ms | 0.581 ms |
...
| metric | llvm-mov | movfuscator |
|---|---:|---:|
| total ELF (bytes) | 730336 | 10221108 |
| .text size | 1291 | 5692 |
| .rodata size | 721152 | 0 |
| mov count / total | 324 / 331 (97.9%) | 1045 / 1047 (99.8%) |
| non-mov mnemonics | `call int jmp` | `call` |
| wall-clock runtime (hyperfine mean) | 0.160 ms | 0.524 ms |
...
| non-mov mnemonics | `call int jmp` | `call` |
| wall-clock runtime (hyperfine mean) | 0.156 ms | 0.535 ms |
...
| non-mov mnemonics | `call int jmp` | `call` |
| wall-clock runtime (hyperfine mean) | 0.175 ms | 0.554 ms |
...
| non-mov mnemonics | `call int jmp` | `call` |
| wall-clock runtime (hyperfine mean) | 0.181 ms | 0.549 ms |
