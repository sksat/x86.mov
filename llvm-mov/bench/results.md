...
Generated 2026-08-26T00:48:15Z on x86_64 (Linux).
...
| wall-clock runtime (hyperfine mean) | 0.198 ms | 0.535 ms | 0.131 ms | 0.119 ms | 0.145 ms | 0.120 ms |
...
| wall-clock runtime (hyperfine mean) | 0.159 ms | 0.532 ms | 0.147 ms | 0.126 ms | 0.116 ms | 0.144 ms |
...
| wall-clock runtime (hyperfine mean) | 0.181 ms | 0.581 ms | 0.128 ms | 0.124 ms | 0.113 ms | 0.122 ms |
...
| wall-clock runtime (hyperfine mean) | 0.168 ms | 0.637 ms | 0.144 ms | 0.125 ms | 0.125 ms | 0.130 ms |
...
| wall-clock runtime (hyperfine mean) | 0.190 ms | 0.641 ms | 0.155 ms | 0.147 ms | 0.149 ms | 0.162 ms |
...
| wall-clock runtime (hyperfine mean) | 0.215 ms | 0.698 ms | 0.132 ms | 0.132 ms | 0.142 ms | 0.148 ms |
...
| wall-clock runtime (hyperfine mean) | 0.204 ms | 0.624 ms | 0.124 ms | 0.127 ms | 0.122 ms | 0.143 ms |
...
| wall-clock runtime (hyperfine mean) | 0.194 ms | 0.619 ms | 0.138 ms | 0.127 ms | 0.160 ms | 0.132 ms |
...
| .text size | 6892 | 8274 | 108 | 48 | 48 | 48 |
| .rodata size | 723968 | 0 | 0 | 0 | 0 | 0 |
| mov count / total | 1870 / 1873 (99.8%) | 1542 / 1544 (99.9%) | 21 / 37 (56.8%) | 7 / 20 (35.0%) | 7 / 20 (35.0%) | 7 / 20 (35.0%) |
...
| wall-clock runtime (hyperfine mean) | 0.204 ms | 0.643 ms | 0.137 ms | 0.122 ms | 0.142 ms | 0.139 ms |
...
| wall-clock runtime (hyperfine mean) | 54.596 ms | 560.012 ms | 0.869 ms | 0.330 ms | 0.254 ms | 0.337 ms |
...
| wall-clock runtime (hyperfine mean) | 0.175 ms | 0.644 ms | 0.123 ms | 0.136 ms | 0.143 ms | 0.140 ms |
...
| wall-clock runtime (hyperfine mean) | 0.192 ms | — | 0.138 ms | 0.142 ms | 0.133 ms | 0.128 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 53.422 ms | — | 0.779 ms | 0.370 ms | 0.322 ms | 0.328 ms |
...
| wall-clock runtime (hyperfine mean) | 0.152 ms | — | — | — | — | — |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.209 ms | — | 0.158 ms | 0.125 ms | 0.133 ms | 0.146 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.201 ms | — | 0.137 ms | 0.125 ms | 0.150 ms | 0.161 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.179 ms | — | 0.141 ms | 0.129 ms | 0.127 ms | 0.125 ms |
...
| .text size | 19999 | — | — | 6219 | 6347 | 6347 |
| .rodata size | 728312 | — | — | 5016 | 5016 | 5016 |
| mov count / total | 4255 / 5476 (77.7%) | — | — | 669 / 1862 (35.9%) | 671 / 1893 (35.4%) | 671 / 1893 (35.4%) |
...
| wall-clock runtime (hyperfine mean) | 0.230 ms | — | — | 0.161 ms | 0.159 ms | 0.136 ms |
...
| metric | llvm-mov (Rust) | movfuscator | rustc -O0 | rustc -O1 | rustc -O2 | rustc -O3 |
|---|---:|---:|---:|---:|---:|---:|
| total ELF (bytes) | 2177268 | — | — | 1242212 | 1242212 | 1242212 |
| .text size | 80917 | — | — | 821 | 1126 | 1088 |
| .rodata size | 855594 | — | — | 42 | 42 | 42 |
| mov count / total | 15209 / 15256 (99.7%) | — | — | 78 / 246 (31.7%) | 111 / 342 (32.5%) | 111 / 334 (33.2%) |
...
| wall-clock runtime (hyperfine mean) | 0.544 ms | — | — | 0.150 ms | 0.161 ms | 0.137 ms |
