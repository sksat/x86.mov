...
Generated 2026-08-25T16:55:43Z on x86_64 (Linux).
...
| wall-clock runtime (hyperfine mean) | 0.163 ms | 0.674 ms | 0.149 ms | 0.146 ms | 0.129 ms | 0.150 ms |
...
| wall-clock runtime (hyperfine mean) | 0.174 ms | 0.641 ms | 0.136 ms | 0.141 ms | 0.138 ms | 0.138 ms |
...
| wall-clock runtime (hyperfine mean) | 0.184 ms | 0.604 ms | 0.136 ms | 0.134 ms | 0.151 ms | 0.126 ms |
...
| wall-clock runtime (hyperfine mean) | 0.207 ms | 0.541 ms | 0.152 ms | 0.151 ms | 0.140 ms | 0.122 ms |
...
| wall-clock runtime (hyperfine mean) | 0.195 ms | 0.605 ms | 0.134 ms | 0.135 ms | 0.141 ms | 0.127 ms |
...
| wall-clock runtime (hyperfine mean) | 0.193 ms | 0.614 ms | 0.131 ms | 0.136 ms | 0.128 ms | 0.133 ms |
...
| wall-clock runtime (hyperfine mean) | 0.191 ms | 0.700 ms | 0.141 ms | 0.128 ms | 0.129 ms | 0.125 ms |
...
| metric | llvm-mov | movfuscator | clang -O0 | clang -O1 | clang -O2 | clang -O3 |
|---|---:|---:|---:|---:|---:|---:|
| total ELF (bytes) | 666524 | 10221204 | 8756 | 8744 | 8744 | 8744 |
| .text size | 1416 | 7650 | 82 | 27 | 27 | 27 |
| .rodata size | 657152 | 0 | 0 | 0 | 0 | 0 |
| mov count / total | 378 / 381 (99.2%) | 1423 / 1425 (99.9%) | 14 / 28 (50.0%) | 3 / 9 (33.3%) | 3 / 9 (33.3%) | 3 / 9 (33.3%) |
...
| wall-clock runtime (hyperfine mean) | 0.163 ms | 0.649 ms | 0.143 ms | 0.131 ms | 0.141 ms | 0.129 ms |
...
| .text size | 7310 | 8274 | 108 | 48 | 48 | 48 |
| .rodata size | 723968 | 0 | 0 | 0 | 0 | 0 |
| mov count / total | 2044 / 2047 (99.9%) | 1542 / 1544 (99.9%) | 21 / 37 (56.8%) | 7 / 20 (35.0%) | 7 / 20 (35.0%) | 7 / 20 (35.0%) |
...
| wall-clock runtime (hyperfine mean) | 0.167 ms | 0.676 ms | 0.150 ms | 0.107 ms | 0.130 ms | 0.126 ms |
...
| wall-clock runtime (hyperfine mean) | 70.573 ms | 557.555 ms | 0.767 ms | 0.340 ms | 0.324 ms | 0.305 ms |
...
| wall-clock runtime (hyperfine mean) | 0.180 ms | 0.552 ms | 0.135 ms | 0.150 ms | 0.137 ms | 0.171 ms |
...
| wall-clock runtime (hyperfine mean) | 0.160 ms | — | 0.143 ms | 0.157 ms | 0.129 ms | 0.127 ms |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 68.448 ms | — | 0.651 ms | 0.321 ms | 0.307 ms | 0.318 ms |
...
| wall-clock runtime (hyperfine mean) | 0.172 ms | — | — | — | — | — |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.202 ms | — | 0.125 ms | 0.135 ms | 0.160 ms | 0.134 ms |
...
| .text size | 6892 | — | 419 | 22 | 22 | 22 |
| .rodata size | 721236 | — | 51 | 0 | 0 | 0 |
| mov count / total | 1785 / 1805 (98.9%) | — | 45 / 114 (39.5%) | 3 / 7 (42.9%) | 3 / 7 (42.9%) | 3 / 7 (42.9%) |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.190 ms | — | 0.129 ms | 0.147 ms | 0.144 ms | 0.150 ms |
...
| .text size | 7478 | — | 497 | 22 | 22 | 22 |
| .rodata size | 721812 | — | 82 | 0 | 0 | 0 |
| mov count / total | 1893 / 1917 (98.7%) | — | 65 / 130 (50.0%) | 3 / 7 (42.9%) | 3 / 7 (42.9%) | 3 / 7 (42.9%) |
...
| deps mov-lowered | 0 / 2 (native: core native(no-ir), compiler_builtins native(no-ir)) | — | — | — | — | — |
| wall-clock runtime (hyperfine mean) | 0.159 ms | — | 0.144 ms | 0.115 ms | 0.122 ms | 0.147 ms |
...
| .text size | 21343 | — | — | 6219 | 6347 | 6347 |
| .rodata size | 728312 | — | — | 5016 | 5016 | 5016 |
| mov count / total | 4654 / 5869 (79.3%) | — | — | 669 / 1862 (35.9%) | 671 / 1893 (35.4%) | 671 / 1893 (35.4%) |
...
| wall-clock runtime (hyperfine mean) | 0.214 ms | — | — | 0.128 ms | 0.122 ms | 0.162 ms |
...
| metric | llvm-mov (Rust) | movfuscator | rustc -O0 | rustc -O1 | rustc -O2 | rustc -O3 |
|---|---:|---:|---:|---:|---:|---:|
| total ELF (bytes) | 2193652 | — | — | 1242212 | 1242212 | 1242212 |
| .text size | 94916 | — | — | 821 | 1126 | 1088 |
| .rodata size | 855594 | — | — | 42 | 42 | 42 |
| mov count / total | 16991 / 17038 (99.7%) | — | — | 78 / 246 (31.7%) | 111 / 342 (32.5%) | 111 / 334 (33.2%) |
...
| wall-clock runtime (hyperfine mean) | 0.712 ms | — | — | 0.116 ms | 0.147 ms | 0.131 ms |
